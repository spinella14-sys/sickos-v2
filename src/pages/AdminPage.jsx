...
export default function AdminPage() {
  ...
  async function handleAuth(e) {
    e.preventDefault()
    if (password === 'dt1mExDJxmaxcr4rNVqb') { setAuthed(true); addLog('Authenticated as commissioner', 'success'); setBidsLoading(true); fetchBids({status:'pending'}).then(data => { setBids(data || []); setBidsLoading(false) }) }
